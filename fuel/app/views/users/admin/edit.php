...
<?=Form::open()?>
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<?=Form::select('lang', $user->lang, ['nl' => __('user.language.nl'), 'en' => __('user.language.en')], ['class' => 'form-control'])?>
			</div>
		</div>
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<?=Form::select('group-id', $user->group_id, $group_options, ['class' => 'form-control'])?>
			</div>
			<div class="form-group">
